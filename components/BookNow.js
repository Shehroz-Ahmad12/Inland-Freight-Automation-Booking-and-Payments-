...
// Shehroz: Font Roboto Codensed




// ShipmentType Details Step 1
...
export default function BookNow ({navigation})  {
  ...
  const [bookingData, setBooking] =React.useState({Type: "LTL",step1: step,PickupCity: '', PickUpAddress: '', DropoffCity: '', DropoffAddress: '',
   GoodsType: '', Description: '', Weight: '', Date:date.toDateString(), Time:date.toTimeString(), Status: 'Pending', Customer: CUSTOMER});

  const clear= ()=>{
    setBooking({Type:'',PickupCity: '', PickUpAddress: '', DropoffCity: '', DropoffAddress: '',
