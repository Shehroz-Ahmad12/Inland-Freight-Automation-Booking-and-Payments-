...
export default function MyCompletedBookingsDriver ({ navigation, route }){
    ...
    return(
      ...
      <FlatList
         ...
         renderItem={({ item, index }) => (
           <TouchableOpacity style={{padding: 15, borderBottomColor:'grey', borderBottomWidth:1}} onPress={()=>{
             console.log("Move to Completed Bookings Driver Details")
             navigation.push('Completed Bookings Driver Details', {item: item, driverId: route.params})}}>
